...
### Week 2 Objectives:
* Create an AWS account and configure robust multi-layer IAM security access controls.
* Complete basic foundational Lab assignments (01 to 07) hosted by AWS Study Group to understand cloud resource management.
...
* Completed Lab 01 through Lab 03, mastering basic budgeting setups to avoid accidental cloud billing overheads.
* Practiced Lab 04 through Lab 07 successfully, grasping foundational AWS storage components and lifecycle policies.